  ...
  function patchHydrate() {
    ...
    wrap("hydrateAdvisor", () => {
      ...
      const replies = [
        ...
        "Fair point. If your conviction on the semis cycle is strong, holding NVDA full size is defensible — but I'd then want bonds and international up a few points to balance the tail risk. Trade-off, not a hard rule.",
      ...
      async function submit() {
        ...
        if (!v) return;
        // User bubble with appear animation
        ...
        typing.style.width = "";
        typing.innerHTML = "";
        typing.classList.add("appear");

        if (state.master && state.typing) {
          await streamText(typing, reply, { tick: 14, charsPerTick: 2 });
        } else {
          typing.textContent = reply;
        }
        // Source line after streaming
